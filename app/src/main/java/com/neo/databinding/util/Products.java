...
/**
 * class contains list of all project in app
 */
public class Products {
    ...
    // hash map to store products as values and serial number as keys in it's list, for easy retrieval of product obj from numb
